      ...
      items: [
        {
          ...
          text: 'Zdrada współmałżonka najczęściej kończy się rozwodem. Statystyki nie kłamią – aby proces rozwodowy przebiegał w poczuciu spełnionego obowiązku i “na spokojnie” - warto udokumentować nielojalność małżeńską męża lub żony.'
        },
        {
          title: 'alimenty i kontrola opieki nad dziećmi',
          text: 'Pomagam udokumentować m.in.: uchylanie się od płacenia alimentów, zaniżanie wynagrodzenia, ukrywanie dochodów, problemy z uzależnieniami czy niewłaściwe zajmowanie się dziećmi przez rodzica, któremu przyznano prawo opieki.'
        },
        {
      ...
      items: [
        {
          ...
          text: 'Celem jest dotarcie do świadków zdarzeń, pozyskanie kluczowych informacji i dowodów szczególnie istotnych dla pozytywnego rozstrzygnięcia toczącej się przed sądem sprawy Zlecającego.'
        },
        {
          title: 'ustalenie miejsca pracy i dochodów',
          text: 'Potwierdzenie miejsca pracy i próba pozyskania informacji na temat stosunku pracy oraz wynagrodzenia otrzymywanego przez osobę będącą przedmiotem zainteresowania Zlecającego.'
        },
        {
          title: 'ustalenie miejsca zamieszkania',
          text: 'Potwierdzenie miejsca zamieszkania osoby lub osób będących przedmiotem zainteresowania Zlecającego.'
        },
        {
          title: 'ustalenie majątku',
          text: 'Czynności detektywistyczne koncentrują się na legalnych metodach pozyskiwania informacji na temat stanu posiadania i trybu życia osoby lub osób będących przedmiotem zainteresowania Zlecającego.'
        }
      ]
    },
    {
